...
var emotions = [
  { "type": 1, "name": "joy", "count": 0, "percentage": 0},
  { "type": 2, "name": "embarassed/disgust", "count": 0, "percentage": 0},
  { "type": 3, "name": "anger/disagree", "count": 0, "percentage": 0},
  { "type": 4, "name": "motivation/approval", "count": 0, "percentage": 0},
  { "type": 5, "name": "sadness/sick", "count": 0, "percentage": 0},
  { "type": 6, "name": "curious/doubt", "count": 0, "percentage": 0},
  { "type": 7, "name": "horny", "count": 0, "percentage": 0},
  { "type": 8, "name": "celebration/achievement", "count": 0, "percentage": 0},
  { "type": 9, "name": "fancy", "count": 0, "percentage": 0},
  { "type": 10, "name": "love/relationship", "count": 0, "percentage": 0},
  { "type": 11, "name": "hungry", "count": 0, "percentage": 0},
  { "type": 12, "name": "fear/shocked", "count": 0, "percentage": 0},
];
var utfEmojis = [
  {
    "type": 1,
...
app.get('/mood/reload', function(req, res) {
  callTwitterAPI();
});
...
app.get('/states/reset', function(req, res) {
